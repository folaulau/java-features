 ...
 *
 */
public class Java9InterfacePrivateMethods {

    static Faker faker = new Faker();

    public static void main(String[] args) {
        // TODO Auto-generated method stub
        System.out.println("Java9InterfacePrivateMethods");
...
interface UserOperations {
    ...
    /**
     * In Java 9, interfaces can have method implementations, but they cannot be public, protected, or private (in the
     * traditional class sense). Instead, they can only be:
     * 
     * default methods (which are public by default), or private (either static or instance methods). The main reason
     * for introducing private methods in interfaces is to:
     * 
     * Break down default methods into smaller, more manageable chunks. Reuse common code between default methods.
     * 
     */
